 ...
 * [memon.yml](memon.yml)
     * Determines how your purl.obolibrary.org/obo/memon/ redirects will be handled
     ...
     * Paste in the contents of [memon.yml](memon.yml)
 ...
 * [memon.md](memon.md)
     ...
     * Paste in the contents of [memon.md](memon.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
